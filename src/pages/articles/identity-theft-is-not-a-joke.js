      ...
      <div class="grid">
        <div class="row">
          ...
          <br class="header_br" />
            ...
            <br class="header_br" />
            <p class="article_text" id="no_indent">The bugs entered their own recording booths and engaged in ten-minute recording sessions, where they sat on microphones and stridulated to their hearts’ content. Researchers thoroughly cleaned and replaced recording booth components between recording sessions to ensure the creatures wouldn't react to other stimuli. Secondary microphones recorded ambient noise in the chambers, and analysts mastered everything in Audacity to produce high-quality audio files of isolated ant sounds. </p>
            <br class="header_br" />
            <div>
