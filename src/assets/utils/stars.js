export default function stars() {
    ...
    // document.getElementsByClassName("pree")[1].style.color = "white"
    
    stars_1.style.transform = "translateY(180%)"
    stars_2.style.transform = "translateY(180%)"
    if (window.innerWidth >= 3800 && window.innerWidth < 3900) {
      stars_1.style.transform = "translateY(118%)"
      stars_1.style.transitionDuration = "11s"
      stars_2.style.transform = "translateY(117%)"
      stars_2.style.transitionDuration = "11s"
    } 
    if (window.innerWidth >= 3720 && window.innerWidth < 3800) {
      stars_1.style.transform = "translateY(120%)"
      stars_1.style.transitionDuration = "11s"
      stars_2.style.transform = "translateY(115%)"
      stars_2.style.transitionDuration = "11s"
    } 
    if (window.innerWidth >= 3650 && window.innerWidth < 3720) {
      stars_1.style.transform = "translateY(112%)"
      stars_1.style.transitionDuration = "11s"
      stars_2.style.transform = "translateY(113%)"
      stars_2.style.transitionDuration = "11s"
    } 
    if (window.innerWidth >= 3250 && window.innerWidth < 3650) {
      stars_1.style.transform = "translateY(91%)"
      stars_1.style.transitionDuration = "11s"
      stars_2.style.transform = "translateY(82%)"
      stars_2.style.transitionDuration = "11s"
    } 
    // lower bound tied to breakpoint
    if (window.innerWidth >= 3100 && window.innerWidth < 3250) {
    ...
    // upper bound tied to breakpoint
    ...
    if (window.innerWidth >= 2700 && window.innerWidth < 2800) {
      stars_1.style.transform = "translateY(102%)"
      stars_1.style.transitionDuration = "13s"
      stars_2.style.transform = "translateY(96%)"
      stars_2.style.transitionDuration = "13s"
    } 
    if (window.innerWidth >= 2500 && window.innerWidth < 2700) {
      stars_1.style.transform = "translateY(108%)"
      stars_1.style.transitionDuration = "9s"
      stars_2.style.transform = "translateY(105%)"
      stars_2.style.transitionDuration = "9s"
    } 
    if (window.innerWidth >= 2200 && window.innerWidth < 2500) {
      stars_1.style.transform = "translateY(103%)"
      stars_1.style.transitionDuration = "10s"
      stars_2.style.transform = "translateY(105%)"
      stars_2.style.transitionDuration = "10s"
    } 
    if (window.innerWidth >= 1980 && window.innerWidth < 2200) {
      stars_1.style.transform = "translateY(111%)"
      stars_1.style.transitionDuration = "10s"
      stars_2.style.transform = "translateY(105%)"
      stars_2.style.transitionDuration = "10s"
    } 
    if (window.innerWidth >= 1750 && window.innerWidth < 1980) {
      stars_1.style.transform = "translateY(94%)"
      stars_1.style.transitionDuration = "9s"
